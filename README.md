...
<p align="center">
  <a href="https://github.com/radkawar/screenlogger/releases/download/v0.1.4/Screenlogger-v0.1.4-macos-universal.dmg"><strong>Download Screenlogger v0.1.4</strong></a>
  <br>
...
- Optionally capture every connected display as one synchronized moment.
...
1. [Download the latest DMG](https://github.com/radkawar/screenlogger/releases/download/v0.1.4/Screenlogger-v0.1.4-macos-universal.dmg).
